$(document).ready(function () {
	...
	$(".form-wrapper div.button-back").click(function () {
		var button = $(this);
		...
		checkSection(currentSectionIndex);
	});
	...
	$(".form-wrapper div.button").click(function () {
		...
		checkSection(currentSectionIndex, firstName, lastName, incomeTotal, debtTotal);
		bounce($('.tipman'));
	});
});

function checkSection(currentSectionIndex, firstName, lastName, incomeTotal, debtTotal) {
